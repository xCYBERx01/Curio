...
export const MOODS: Record<SectionId, Mood> = {
  intro: { keyIntensity: 1.1, keyColor: '#dfe4f5', rimIntensity: 0.5, ambientIntensity: 0.5 },
  ahmed: { keyIntensity: 1.5, keyColor: '#f4f1e8', rimIntensity: 0.45, ambientIntensity: 0.65 },
  croc: { keyIntensity: 1.7, keyColor: '#ffd9c2', rimIntensity: 0.4, ambientIntensity: 0.6 },
  voltedge: { keyIntensity: 1.6, keyColor: '#eef0f5', rimIntensity: 0.6, ambientIntensity: 0.65 },
  arm: { keyIntensity: 1.5, keyColor: '#d7e2f5', rimIntensity: 0.55, ambientIntensity: 0.6 },
  interests: { keyIntensity: 1.2, keyColor: '#e8e4da', rimIntensity: 0.5, ambientIntensity: 0.55 },
  contact: { keyIntensity: 0.8, keyColor: '#cfd4e6', rimIntensity: 0.35, ambientIntensity: 0.4 },
}
